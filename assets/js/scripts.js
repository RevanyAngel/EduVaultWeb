document.addEventListener('DOMContentLoaded', function () {
    ...
    const newReleaseBooks = [
        { title: 'Pengembangan Sistem Informasi Tagihan Air Bersih Desa', author: 'M. Imam Fathulloh Al Bahri', img: '/assets/images/D.png', pdf:'/EduVault/jurnal/4.pdf' },
        { title: 'Database MySQL', author: 'Abdul Kadir', img: '/assets/images/cover buku_Tuntunan Praktis Belajar Database.avif' },
        { title: 'Audit Tata Kelola TI Pada BMKG Dengan Menggunakan Framework COBIT 2019', author: 'Ade Irma Aprianingsih', img: '/assets/images/A.png', pdf:'/EduVault/jurnal/1.pdf' },
        { title: 'ALjabar Linear Dasar', author: 'Qurrotul Aini', img: '/assets/images/cover buku_aljabar linear dasar.jpeg' },
    ...
    const trendingBooks = [
        ...
        { title: 'Pemrograman Bahasa C#', author: 'Budi Raharjo', img: '/assets/images/A1.jpg' },
        { title: 'Rancang Bangun Aplikasi Manajemen Kos', author: 'Daris Irfan Putrawanto', img: '/assets/images/F.png', pdf:'/EduVault/jurnal/6.pdf' },
        { title: 'Pengantar Metode Numerik', author: 'Dr. Elis Ratna Wulan', img: '/assets/images/cover buku_pengantar metode numerik.jpg' },
        { title: 'Penerapanan Model Deteksi Objek Untuk Robot', author: 'Ilham Rizqyakbar', img: '/assets/images/E.png', pdf:'/EduVault/jurnal/5.pdf' }
    ];
